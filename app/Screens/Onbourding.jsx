...
const Onboarding = () => {
  ...
  const handleskip=()=>{
    router.push('/Screens/Onbourding2')
  }
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>
        Explore Different Movie Ideas and share your vision about it.
      </Text>
...
const styles = StyleSheet.create({
  ...
  logoContainer: {
    marginBottom: windowWidth < 400 ? 10 : 20,
  },
  logo: {
  ...
  description: {
    ...
    color: '#606060',
    fontSize: windowWidth < 400 ? 14 : 16,
    marginBottom: windowWidth < 400 ? 5 : 10,
  },
  additionalDescription: {
    textAlign: 'center',
    color: '#A7A7A7',
    fontSize: windowWidth < 400 ? 12 : 14,
    marginTop: windowWidth < 400 ? 5 : 10,
  },
  stepLine: {
    flexDirection: 'row',
    alignItems: 'center',
    marginTop: windowWidth < 400 ? 10 : 20,
  },
  yellowLine: {
    width: windowWidth < 400 ? 30 : 30,
    height: 2,
  ...
  nextButton: {
    ...
    marginTop: windowWidth < 400 ? 20 : 30,
    paddingVertical: 12,
