  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.checkboxContainer}>
        ...
        />
        <Text style={styles.checkboxLabel}>I hereby accept the Terms and Conditions</Text>
      </View>
      <TouchableOpacity style={styles.buttonContainer} disabled={!agreeToTerms} onPress={HandleContinue}>
